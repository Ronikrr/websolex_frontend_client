            ...
            <div className="col-12 d-flex flex-wrap justify-content-center">
              <div className="col-12 col-md-6 col-xl-3 hover d-flex justify-content-center flex-column text-center arrorw_1 position-relative mb-4 mb-lg-0 wow animate__animated animate__fadeInLeft">
                ...
                <div className="job_content">
                  ...
                  <p className="mb-0">
                    ...
                    business goals and technical requirements. Our team
                    collaborates with you to create a tailored project plan,
                    ensuring all aspects are aligned with your vision.
                  </p>
                </div>
              </div>
              <div className="col-12 col-md-6 col-xl-3 hover d-flex justify-content-center flex-column text-center arrorw position-relative mb-4 mb-lg-0 wow animate__animated animate__fadeInLeft">
                ...
                <div className="job_content">
                  ...
                  <p className="mb-0">
                    Our expert designers and developers bring your project to
                    life, focusing on creating a user-friendly and visually
                    appealing interface. We ensure that the design is responsive
                    and optimized for all devices, while the development adheres
              ...
              <div className="col-12 col-md-6 col-xl-3 hover d-flex justify-content-center flex-column text-center arrorw_2 position-relative mb-4 mb-lg-0 wow animate__animated animate__fadeInRight">
                ...
                <div className="job_content">
                  ...
                  <p className="mb-0">
                    ...
                    resolve any issues. Our quality assurance process ensures
                    that the final product is bug-free, secure, and performs
              ...
              <div className="col-12 col-md-6 col-xl-3 hover d-flex justify-content-center flex-column text-center mb-4 mb-lg-0 wow animate__animated animate__fadeInRight">
                ...
                <div className="job_content">
                  ...
                  <p className="mb-0">
                    We offer flexible and scalable WordPress development
                    solutions. Whether you need a custom theme, plugin
                    development, or a full-fledged e-commerce site, we ensure
                    your WordPress site is optimized for performance, security,
                    and ease of use.
                  </p>
                </div>
              </div>
